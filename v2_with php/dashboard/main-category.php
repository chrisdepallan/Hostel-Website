...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/main-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:23 GMT -->
<head>
...
echo  "#".$i;
echo"</td>";
echo "<td> <img style='border-radius:50%;width:50px;height:50px' src='assets/img/category/";
echo $row['cate_photo'];
echo"'></td>";
echo "<td>";
echo $row['cate_category'];
echo "<td>value</td>";
echo '<td><div class="form-check form-switch"><input onclick="toggle('.$row['cate_id'].')" type="checkbox" id="status" class="form-check-input"';
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/main-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:24 GMT -->
</html>
<?php
