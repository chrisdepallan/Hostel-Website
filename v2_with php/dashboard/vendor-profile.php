...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/vendor-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:14 GMT -->
<head>
	<meta charset="utf-8" />
									...
									<div class="tab-content px-3 px-xl-5" id="myTabContent">
										...
										<div class="tab-pane fade show active" id="purchased" role="tabpanel"
											...
											<div class="tab-widget mt-5">
												...
												<div class="row">
<?php 
												$queryp =    "SELECT * FROM `tbl_products` where prod_mid='".$_GET['id']."'";

           		 $resultp = mysqli_query($con, $queryp);
            while ($rowp = mysqli_fetch_array($resultp)) {
				$i = explode(" ", $rowp['prod_photo']);
           ?>
													<div class="col-lg-3 col-md-6 col-sm-6">
														<div class="card-wrapper">
															<div class="card-container">
																<div class="card-top">
																	<img class="card-image" width='235px' height='235px' src="assets/img/products/<?php echo $i[0]; ?>" alt="">
																</div>
																<div class="card-bottom">
																	<h3><a href="#"><?php echo $rowp["prod_name"]?></a></h3>
																	<p>$<?php echo $rowp["prod_price"]?></p>
																</div>
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/vendor-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:23 GMT -->
</html>
<?php
    ...
    echo "<script type='text/javascript'> window.location.href = 'vendor-list.php'</script>";
}
?>
<?php
