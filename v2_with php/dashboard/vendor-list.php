...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/vendor-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:10 GMT -->
<head>
									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table">
											...
											while($row=mysqli_fetch_array($result))
										   {
											...
											echo"</td>";
											echo "<td>";
											?><img class="cat-thumb" src="../uploads/<?php echo $row1['regdet_photo']?>"
...
<button type="button"
	class="btn btn-outline-success" onclick='location.href=vendor-profile.php?id=<?php  echo $row["logdet_id"];?>'>Info</button>
<button type="button"
...
<div class="dropdown-menu">
	<a class="dropdown-item" href="vendor-profile.php?id=<?php echo $row["logdet_id"];?>">Info</a>
</div>
</div>
</form></td>
<?php
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/vendor-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:14 GMT -->
</html>
<?php
