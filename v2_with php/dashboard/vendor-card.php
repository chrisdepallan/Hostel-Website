...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/vendor-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:04 GMT -->
<head>
	<meta charset="utf-8" />
...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-dark ec-header-light" id="body">
	...
	<div class="wrapper">
		...
		<!-- LEFT MAIN SIDEBAR -->				<div class="ec-left-sidebar ec-bg-sidebar">
						...
						<div class="row"><?php
							...
							<div class="col-lg-3 col-md-6 col-sm12 col-12">
								...
								<div class="user_card_wrapper_one">
									<img style =' width:100px;border-radius:50%'src="../uploads/<?php echo $row1['regdet_photo']?>" alt="">
									<h3></h3>
									<p><?php echo $row1['regdet_name']?></p>
									...
									<a href="vendor-profile.php?id=<?php echo $row['logdet_id']?>">View details</a>
								</div>
							</div><?php }?>
							</div>
						<div class="dataTables_paginate paging_simple_numbers paginate_customs" id="responsive-data-table_paginate">
							<ul class="pagination">
								<li class="paginate_button page-item previous disabled"
									id="responsive-data-table_previous"><a href="#"
										aria-controls="responsive-data-table" data-dt-idx="0" tabindex="0"
										class="page-link">Previous</a></li>
								<li class="paginate_button page-item active"><a href="#"
										aria-controls="responsive-data-table" data-dt-idx="1" tabindex="0"
										class="page-link">1</a></li>
								<li class="paginate_button page-item next disabled" id="responsive-data-table_next"><a
										href="#" aria-controls="responsive-data-table" data-dt-idx="2" tabindex="0"
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/vendor-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:10 GMT -->
</html>
<?php
