...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/add-vendor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:23 GMT -->
<head>
	<meta charset="utf-8" />
...
<div class="row d-flex justify-content-center">
  <div class="col-lg-8">
	...
	<form method="POST" action='' enctype='multipart/form-data'>
	  ...
	  <!-- Password input -->
	  <div class="form-floating mb-4">
		<input type="text" class="form-control" maxlength="10" id="phno"   required name='phno' onkeyup="myphno()" placeholder="name@example.com">
