...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/user-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:23 GMT -->
<head>
	<meta charset="utf-8" />
			...
			<div class="ec-content-wrapper ec-ec-content-wrapper mb-m-24px">
				<div class="content">
					...
					<div class="row"><?php
											$i=0;
											$con = mysqli_connect("localhost", "root", "", "modderhub") or die("Connect failed: %s\n" . $con->error);
											$query=	"SELECT * FROM `tbl_login_details` where logdet_role='buyer'";
							...
							<div class="col-lg-3 col-md-6 col-sm12 col-12">
								...
								<div class="user_card_wrapper_one">
									...
									<a href="user-profile.php?id=<?php echo $row['logdet_id']?>">View details</a>
								</div>
							</div><?php }?>
