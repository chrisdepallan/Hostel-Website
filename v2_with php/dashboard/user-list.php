...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/user-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Feb 2023 04:18:23 GMT -->
...
<button type="button"
	class="btn btn-outline-success" onclick='location.href=user-profile.php?id=<?php  echo $row["logdet_id"];?>'>Info</button>
<button type="button"
...
<div class="dropdown-menu">
	<a class="dropdown-item" href="user-profile.php?id=<?php echo $row["logdet_id"];?>">Info</a>
</div>
</div>
</form></td>
<?php
