...
<!-- Mirrored from azyrusthemes.com/forum2019/demo/page-create-topic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Mar 2023 07:16:30 GMT -->
<head>
    <meta charset="utf-8">
...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-wrapper-inner">
            ...
            <form  method="POST" enctype="multipart/form-data" class="form-default form-create-topic">
                <div class="form-group">
                    <label for="inputTopicTitle">Topic Title</label>
                    <div class="tt-value-wrapper">
                        <input type="text" name="topic" class="form-control" id="inputTopicTitle" required placeholder="Subject of your topic">
                ...
                <div class="pt-editor">
                    ...
                    <div class="form-group">
                        <textarea name="message" class="form-control" rows="5" maxlength='501' required placeholder="Lets get started"></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                        <div class="form-group">
                        <label for="inputTopicTags">Image</label>
                                <input type="file" id='file' class="form-control" onchange='isImage()' name='file' >
                     ...
                     <div class="row">
                        <div class="col-auto ml-md-auto">
                            <input type='submit' value='Create Post' id='submit' name='submit' class="btn btn-secondary btn-width-lg"></input>
                        </div>
                    </div>
                </div>
            </form>
...
if (isset($_POST["submit"])) {
  ...
  $qc = "INSERT INTO `tbl_forum`(`forum_puid`, `forum_topic`, `forum_content`, `forum_photo`,`forum_category`) 
  VALUES ('".$_SESSION['id']."','$topic','$content','$file','$tags')";
