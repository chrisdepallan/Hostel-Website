...
<!-- Mirrored from azyrusthemes.com/forum2019/demo/page-categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Mar 2023 07:16:30 GMT -->
...
<head>
  ...
  var elements = document.getElementsByI
  
  d(tag);
  
  // If there are no elements with the tag name, return
  if (elements.length === 0) {
    return;
  }
  
  // Get the first element with the tag name and scroll to it
        ...
        <div class="tt-custom-mobile-indent container">
            ...
            <div class="tt-categories-list">
                <div class="row">
                    ...
                    $count_array = array(); // Array to store count of tags
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            foreach ($tags_arr as $tag) {
                                ...
                                if (!in_array($tag, $tags_array)) {
                                  $tags_array[] = $tag;
                                  $count_array[$tag] = 1; // Set count to 1 for new tag
                                  // Retrieve definition text for new tag from Urban Dictionary
                                 
                                } else {
                                  $count_array[$tag]++; // Increment count for existing tag
                                }
                            }
                        }
                    }
                            ...
                            <div class="tt-item">
                                <div class="tt-item-header">
                                    <ul class="tt-list-badge">
                                        <li><a href="#"><span class="tt-color01 tt-badge"><?php echo $tag . "<br>"; ?></span></a></li>
                                    </ul>
                                    <h6 class="tt-title"><a href="page-categories-single.html">Threads: <?php echo $count_array[$tag];?></a></h6>
                                </div>
                                <div class="tt-item-layout">
                                    <div class="innerwrapper">
                                        <?php 
                                        // echo  $definition_array[$tag];
                                        ?>
                                    </div>
                                    <!-- <div class="innerwrapper">
