...
<!-- Mirrored from azyrusthemes.com/forum2019/demo/page-single-topic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Mar 2023 07:16:30 GMT -->
<head>
    <meta charset="utf-8">
  ...
  document.getElementById("sh1").innerHTML='link copied';
            ...
            <div class="row tt-row no-gutters">
                <div class="col-auto">
                    ...
                    <div class="tt-desktop-menu">
                        <nav>
                            <ul>
                                <li><a href="page-categories.php"><span>Categories</span></a></li>
                                <!-- <li><a href="page-tabs.php"><span>Trending</span></a></li> -->
                                <li><a href="page-create-topic.php"><span>New</span></a></li>
                                <!-- <li>
                                    <a href="page-single-user.php"><span>Pages</span></a>
                                    <ul>
        ...
        <div class="tt-single-topic-list">
            <div class="tt-item">
                 <div class="tt-single-topic">
                        ...
                        <div class="tt-item-info info-top">
                            <div class="tt-avatar-icon">
                                <?php
                                 ...
                                 $query = "SELECT * FROM `tbl_forum` where forum_postid='".$_GET['id']."'";
                                 $result = mysqli_query($con, $query);
                                 $row = mysqli_fetch_array($result);

                                 $query1 = "SELECT * FROM `tbl_login_details` where logdet_id='".$row['forum_puid']."'";
                                 ...
                                 ?>
                                <!-- <i class="tt-icon"><svg><use xlink:href="../uploads/"></use></svg></i> -->
                            </div>
                            <div class="tt-avatar-title">
                               <a href="page-single-user.php?id=<?php echo $row1['logdet_id'];?>"><?php echo  $row2['regdet_name']; ?></a>
                            </div>
                            <a href="#" class="tt-info-time">
                                <i class="tt-icon"><svg><use xlink:href="#icon-time"></use></svg></i><?php echo  $row['forum_time']; ?>
                            </a>
                        </div>
                        <h3 class="tt-item-title">
                            <a href="#"><?php echo  $row['forum_topic']; ?></a>
                        </h3>
                        <div class="tt-item-tag">
                            <ul class="tt-list-badge">
                                <?php
                            $i=explode(",",$row['forum_category']);
                            $k=sizeof($i);
                            foreach ($i as $j)
                            {?>

                                <li><a href="#"><span class="tt-color03 tt-badge"><?php echo $j?></span></a></li>
                                <?php
                                }?>
                    ...
                    <p><?php echo  $row['forum_content']; ?>
                </p>    
                <img src="uploads/<?php echo  $row['forum_photo'];?>" alt="">
                    ...
                    <!-- <div class="tt-item-info info-bottom">
                        ...
                        <a  onclick='shareURL() ' class="tt-icon-btn tt-hover-02 tt-small-indent">
                            <i class="tt-icon"><svg><use xlink:href="#icon-share"></use></svg></i>
                            <span class='share' id='sh1'></span>
                        </a>
                        <a href="#" class="tt-icon-btn tt-hover-02 tt-small-indent">
                            <i class="tt-icon"><svg><use xlink:href="#icon-flag"></use></svg></i>
                        </a>
                        <a href="#replyx" class="tt-icon-btn tt-hover-02 tt-small-indent">
            ...
            <!-- <div class="tt-item">
             ...
             <?php
                ...
                $con = mysqli_connect("localhost", "root", "", "modderhub") or die("Connect failed: %s\n" . $con->error);
                $queryfr = "SELECT * FROM `tbl_forumreply` where freply_postid='".$_GET['id']."'";
                $resultfr = mysqli_query($con, $queryfr);
                while ($rowfr = mysqli_fetch_array($resultfr)) {
                    $queryfr1 = "SELECT * FROM `tbl_reg_details` where regdet_lid= '".$rowfr['freply_uid']."'";
                    $resultfr1 = mysqli_query($con, $queryfr1);
                    $rowfr1 = mysqli_fetch_array($resultfr1);
                 ...
                 <div class="tt-single-topic">
                    <div class="tt-item-header pt-noborder">
                        <div class="tt-item-info info-top">
                            ...
                            <div class="tt-avatar-title">
                               <a href="#"><?php echo $rowfr1['regdet_name']; ?></a>
                            </div>
                            <a href="#" class="tt-info-time">
                                <i class="tt-icon"><svg><use xlink:href="#icon-time"></use></svg></i><?php echo $rowfr['freply_time']; ?>
                            </a>
                        </div>
                    </div>
                    <div class="tt-item-description">
                        <p>
                        <?php echo $rowfr['freply_content']; ?>
                        </p>
                        <p>
                            <img class="tt-offset-11" src="uploads/<?php echo $rowfr['freply_photo']?>" alt="">
                        </p>
                    </div>
                    <div class="tt-item-info info-bottom">
                        <!-- <a href="#" class="tt-icon-btn">
      ...
      -->
        ...
        <div class="tt-wrapper-inner">
            <div class="pt-editor form-default">
              ...
              -->
                <div id='replyx' class="form-group">
                    <form  method="POST" enctype="multipart/form-data">
                    <textarea name="message" class="form-control" rows="5" placeholder="Lets get started"></textarea>
  
 <label for="file-input">Upload a image:</label>
 <input type="file" name='file' id="file-input" >
 <div class="col-auto">
 <input type='submit'value="Reply" name='submit'class="btn btn-secondary btn-width-lg">
...
if (isset($_POST["submit"])) {
  ...
  $con = mysqli_connect("localhost", "root", "", "modderhub") or die("Connect failed: %s\n" . $con->error);
  $qc = "INSERT INTO `tbl_forumreply`(`freply_content`, `freply_photo`, `freply_status`, `freply_postid`, `freply_uid`) VALUES ('$content','$file','1','".$_GET['id']."','".$_SESSION['id']."')";
...
<!-- Mirrored from azyrusthemes.com/forum2019/demo/page-single-topic.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Mar 2023 07:16:48 GMT -->
</html>
<?php
}
else
