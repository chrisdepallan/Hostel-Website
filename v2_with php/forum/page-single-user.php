...
<!-- Mirrored from azyrusthemes.com/forum2019/demo/page-single-user.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Mar 2023 07:16:30 GMT -->
...
window.onload = function() {
  var element = document.getElementById("tt-tab-02");
  element.scrollIntoView();
    ...
    $query2 = "SELECT * FROM `tbl_reg_details` where regdet_lid='" . $row1['regdet_id'] . "'";
            ...
            <div class="container">
                <div class="tt-user-header">
                    <div class="tt-col-avatar">
                        <div class="tt-icon">
                            <img class='tt-icon' style='border-radius:50%' src="../uploads/<?php echo $row1["regdet_photo"];  ?>" alt="">

                        </div>
                    </div>
                    <div class="tt-col-title">
                        <div class="tt-title">
                            <a href="#"><?php echo $row1["regdet_name"];  ?></a>
                        </div>
                 ...
                 -->
                    ...
                    <div class="tab-pane tt-indent-none" id="tt-tab-02" role="tabpanel">
                        <div class="tt-topic-list">
                            ...
                            $con = mysqli_connect("localhost", "root", "", "modderhub") or die("Connect failed: %s\n" . $con->error);
                            $queryt = "SELECT * FROM `tbl_forum` where  `forum_puid` ='" . $_GET['id'] . "'";
                            ...
                            while($rowt = mysqli_fetch_array($resultt)){
                                ...
                                $queryt1 = "SELECT * FROM `tbl_login_details` where logdet_id='" . $rowt['forum_puid'] . "'";
                                $resultt1 = mysqli_query($con, $queryt1);
                                $rowt1 = mysqli_fetch_array($resultt1);

                                $queryt2 = "SELECT * FROM `tbl_reg_details` where regdet_lid='" . $rowt1['logdet_id'] . "'";
                                $resultt2 = mysqli_query($con, $queryt2);
                                $rowt2 = mysqli_fetch_array($resultt2);

                                $i = explode(",", $rowt['forum_category']);
                            ?>
                                <div class="tt-item tt-itemselect">
                                    <div class="tt-col-avatar">
                                        <img class='tt-icon' style='border-radius:50%' src="../uploads/<?php echo $rowt2["regdet_photo"];  ?>" alt="">
                                    </div>
                                    <div class="tt-col-description">
                                        <h6 class="tt-title"><a href="page-single-topic.php?id=<?php echo $rowt['forum_postid'] ?>">
                                                <svg class="tt-icon">
                                                    <use xlink:href="#icon-pinned"></use>
                                                </svg>
                                                <?php
                                                echo $rowt['forum_topic'];
                                                ?>
                                            </a></h6>
                                        <div class="row align-items-center no-gutters">
                                            <div class="col-11">
                                    ...
                                    <div class="tt-col-category"><span class="tt-color01 tt-badge"><?php echo $i[0]; ?></span></div>
                    ...
                    <div class="tab-pane tt-indent-none" id="tt-tab-03" role="tabpanel">
                        <div class="tt-topic-list">
                            ...
                            $con = mysqli_connect("localhost", "root", "", "modderhub") or die("Connect failed: %s\n" . $con->error);
                            // $queryt = "SELECT * FROM `tbl_forum` where `forum_puid` ='" . $_GET['id'] . "'";
                            $queryt1="SELECT * FROM `tbl_forumreply` ";
                            $resultt1 = mysqli_query($con, $queryt1);
                            
                            while ($rowt1 = mysqli_fetch_array($resultt1)) {
                                $queryz = "SELECT * FROM `tbl_forum` where `forum_postid` ='" . $rowt1['freply_postid'] . "' and  `forum_puid` ='" . $_GET['id'] . "'";
                                // $queryt1 = "SELECT * FROM `tbl_login_details` where logdet_id='" . $rowt['forum_puid'] . "'";
                                $resultz = mysqli_query($con, $queryz);
                                $rowz = mysqli_fetch_array($resultz);
                                
                                if(isset($rowz['forum_topic']))
                                {
                                     
                                
                                $i = explode(",", $rowz['forum_category']);
                            ?>
                            <div class="tt-item">
                                <!-- <div class="tt-col-avatar">
                                    <svg class="tt-icon">
                                ...
                                <div class="tt-col-description">
                                    <h6 class="tt-title"><a href="#">
                                            <?php echo $rowz['forum_topic'];?>
                                        </a></h6>
                                    <div class="row align-items-center no-gutters hide-desktope">
                                        <div class="col-9">
                                            <ul class="tt-list-badge">
                                                <li class="show-mobile"><a href="#"><span class="tt-color06 tt-badge"><?php echo $i[0]?></span></a></li>
                                            </ul>
                                        </div>
                                        <div class="col-3 ml-auto show-mobile">
                                            <div class="tt-value">5 Jan,19</div>
                                    ...
                                    <?php echo $rowt1['freply_content'];?>
                                    </div>
                                </div>
                                <div class="tt-col-category"><a href="#"><span class="tt-color06 tt-badge"><?php echo $i[0]?></span></a></div>
                                <div class="tt-col-value-large hide-mobile"><?php echo $rowt1['freply_time'];?></div>
                            </div>
                            <?php
                            }}
                            ?>
    ...
    <a href="page-create-topic.php" class="tt-btn-create-topic">
        <span class="tt-icon">
            <svg>
