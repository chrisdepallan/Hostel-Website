...
<!-- Mirrored from azyrusthemes.com/forum2019/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Mar 2023 07:16:08 GMT -->
            ...
            <div class="row tt-row no-gutters">
                <div class="col-auto">
                    ...
                    <div class="tt-search">
                        ...
                        <form class="search-wrapper" method="POST" action="search.php">
                            <div class="search-form">
                                <input type="text" class="tt-search__input" name="search_term" placeholder="Search">
    ...
    <main id="tt-pageContent" class="tt-offset-small">
        <div class="container">
            <div class="tt-topic-list">
                ...
                // Split the search string into an array of individual search terms
                $search_terms = explode(" ", $search_string);

                // Construct the SQL query to filter by topic, content, and category
                $sql = "SELECT `forum_postid`, `forum_puid`, `forum_topic`, `forum_content`, `forum_photo`, `forum_time`, `forum_votes`, `forum_status`, `forum_category`
        FROM `tbl_forum`
        WHERE";

                // Loop through the search terms and add them to the query using the OR operator
                foreach ($search_terms as $search_term) {
                    $sql .= " `forum_topic` LIKE '%" . $search_term . "%' OR `forum_content` LIKE '%" . $search_term . "%' OR `forum_category` LIKE '%" . $search_term . "%'";
                ...
                ?>
                        <div class="tt-item tt-itemselect">
                            <div class="tt-col-avatar">
                                <img class='tt-icon' style='border-radius:50%' src="../uploads/<?php echo $row2["regdet_photo"];  ?>" alt="">
                            </div>
                            <div class="tt-col-description">
                                <h6 class="tt-title"><a href="page-single-topic.php?id=<?php echo $row['forum_postid'] ?>">
                                        <svg class="tt-icon">
                                            <use xlink:href="#icon-pinned"></use>
                                        </svg>
                                        <?php
                                        echo $row['forum_topic'];
                                        ?>
                                    </a></h6>
                ...
                <!-- <div class="tt-item tt-itemselect">
                    ...
                    <div class="tt-col-description">
                        <h6 class="tt-title"><a href="page-single-topic.php">
                                <svg class="tt-icon">
                                    <use xlink:href="#icon-pinned"></use>
                                </svg>
...
<!-- Mirrored from azyrusthemes.com/forum2019/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Mar 2023 07:16:30 GMT -->
