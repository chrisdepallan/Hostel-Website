                ...
                ">
                        <div class="card-body p-5 shadow-5 text-center">
                            ...
                            <form action='' method="POST">
                                ...
                                <!-- Email input -->
                                <!-- Submit button -->
                                <input value='Sign in \(￣︶￣*\))' type="submit" id='codesubmit' name='submit' class="btn  btn-outline-danger btn-block mb-4">
                            </form>
...
if(isset($_POST['submit'])){
    ...
    if($_SESSION['otp'] ==$otp){
        ...
        $q="UPDATE `tbl_login_details` SET `logdet_status`=1 WHERE logdet_email='".$_SESSION['email']."'";
